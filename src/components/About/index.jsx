...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{t('Biz haqimizda')} | WT Logistic</title>
        <meta
          name="description"
          content={t(
            "Yuk tashish bozorida 5 yildan ortiq faoliyat yuritayotgan, Yevropa, Rossiya, Turkiya va MDH mamlakatlariga avtomobil yuk tashish xizmatlarini taklif etuvchi kompaniya."
          )}
        />
        <meta
          name="keywords"
          content={t(
            'Biz haqimizda, WT Logistic, Yuk tashish, Transport xizmati, Yuk mashinalari, Ekspeditsiya, Tranzit, Bojxona brokeri, Yevropa yuk tashish, Oʻzbekiston logistika'
          )}
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.wtlogistic.uz/about" />
        <meta property="og:title" content={t('Biz haqimizda')} />
        <meta
          property="og:description"
          content={t(
            "Yuk tashish, konsolidatsiyalangan tashish va ekspeditsiya xizmatlarida ishonchli hamkor."
          )}
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.wtlogistic.uz/about" />
        <meta property="og:image" content="https://www.wtlogistic.uz/og-image.jpg" />
      </Helmet>
